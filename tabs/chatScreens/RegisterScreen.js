 ...
 * it contains functionality for a register screen
 * and it works, but was not necessary
 */
    ...
    Firebase.auth()
      ...
      .then((authUser) => {
        authUser.user.updateProfile({
          ...
          photoURL:
            imageUrl ||
            "https://cencup.com/wp-content/uploads/2019/07/avatar-placeholder.png", //default image
        });
      })
